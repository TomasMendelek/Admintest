...
export const ProductForm: React.FC<ProductFormProps> = ({
    ...
    const description = initialData ? "Editar un producto existente" : "Crear un nuevo producto";
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    >
                                        <FormControl>
                                            <SelectTrigger>
                                                <SelectValue defaultValue={field.value} placeholder="Selecciona un talle" />
                                            </SelectTrigger>
                                        </FormControl>
                                        <SelectContent>
                                            {sizes.map((size) => (
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        >
                                            <FormControl>
                                                <SelectTrigger>
                                                    <SelectValue defaultValue={field.value || ''} placeholder="Selecciona una marca" />
                                                </SelectTrigger>
                                            </FormControl>
                                            <SelectContent>
                                                {brands.map((brand) => (
                            ...
                            render={({ field }) => (
                                <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                                    ...
                                    <div className="space-y-1 leading-none">
                                        ...
                                        <FormDescription>
                                            Este producto podra aparecer en la pagina de inicio.
                                        </FormDescription>
                                    </div>
                                </FormItem>
                            )}
