...
export const BillboardForm: React.FC<BillboardFormProps> = ({
    ...
    const description =  initialData ? "Editar una publicidad existente" : "Crear una nueva publicidad";
    ...
    const onDelete = async () => {
        try {
            ...
            toast.error("Asegurate de eliminar primero todas las categorias que utilizan esta publicidad.");
        } finally {
            setLoading(false)
            setOpen(false)
        }
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input disabled={loading} placeholder="Nombre de la publicidad" {...field} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
