...
const formSchema = z.object({
    ...
    value: z.string().min(4).regex(/^#/, {
        message: 'Debe tener un codigo hex valido'
    }),
});
...
export const ColorForm: React.FC<ColorFormProps> = ({
    ...
    const description =  initialData ? "Editar un color existente" : "Crear un nuevo color";
    ...
    const onDelete = async () => {
        try {
            ...
            toast.error("Asegurate de eliminar primero todos las productos que utilizan este color.");
        } finally {
            setLoading(false)
            setOpen(false)
        }
                                ...
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <div className="flex items-center gap-x-4">
                                            <Input disabled={loading} placeholder="Valor del color (HEX)" {...field} />
