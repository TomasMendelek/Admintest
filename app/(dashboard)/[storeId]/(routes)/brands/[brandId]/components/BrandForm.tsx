...
export const BrandForm: React.FC<BrandFormProps> = ({
    ...
    const description = initialData ? "Editar una marca existente" : "Crear una nueva marca";
    ...
    const onDelete = async () => {
        try {
            ...
            toast.error("Asegúrate de eliminar primero todos los productos que utilizan esta marca.");
        } finally {
            setLoading(false)
            setOpen(false)
        }
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input disabled={loading} placeholder="Nombre de la marca" {...field} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
