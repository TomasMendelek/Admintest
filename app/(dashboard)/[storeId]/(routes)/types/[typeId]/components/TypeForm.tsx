...
export const TypeForm: React.FC<TypeFormProps> = ({
    ...
    const description =  initialData ? "Editar un tipo existente" : "Crear un nuevo tipo";
    ...
    const onDelete = async () => {
        try {
            ...
            toast.error("Asegúrate de eliminar primero todos los productos que utilizan este tipo.");
        } finally {
            setLoading(false)
            setOpen(false)
        }
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input disabled={loading} placeholder="Nombre del tipo" {...field} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
